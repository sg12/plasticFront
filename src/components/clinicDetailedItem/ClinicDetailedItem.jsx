...
const ClinicDetailedItem = ({ clinic }) => {
  ...
  const handleReviewSubmit = async () => {
    ...
    await PlasticServices.postClinicReview(data, clinic.id);
  };
  ...
  return (
    <div className="clinic-detailed-item">
      <div className="clinic-detailed-item__box-title">
        ...
        <Review />
        <button
          className="clinic-detailed-item__review-button"
          onClick={() => {
            privateReviews();
          }}
        >
        ...
        <CenterModal visible={alertModal} setVisible={setAlertModal}>
          ...
          >
            Вам нужно авторизоваться, чтобы оставлять отзывы
          </h3>
          <Link
            to={"/enterPage"}
            style={{ textDecoration: "none", color: "white" }}
          >
            <FieldButton>Войти</FieldButton>
          </Link>
        </CenterModal>
        <h2 className="title-doctor">{clinic.name || "Name"}</h2>
      </div>
      {averageRating !== null && (
      ...
      <CenterModal visible={modal3} setVisible={setModal3}>
        <div className="clinic-detailed-item__modal-send-review">
          <h3 className="clinic-detailed-item__modal-send-review-title">
            Оставить отзыв о клинике
          </h3>
          <div className="clinic-detailed-item__modal-send-review-block">
            <p className="clinic-detailed-item__modal-send-review-description">
              Здание и помещения
            </p>
            <Stars
              totalStars={5}
              onChange={(rating) =>
                handleReviewChange(0, rating, "Здание и помещения")
              }
            />
          </div>
          ...
          <div className="clinic-detailed-item__modal-send-review-block">
            ...
            <Stars
              totalStars={5}
              onChange={(rating) =>
                handleReviewChange(1, rating, "Оборудование и медикаменты")
              }
            />
          </div>
          ...
          <div className="clinic-detailed-item__modal-send-review-block">
            ...
            <Stars
              totalStars={5}
              onChange={(rating) =>
                handleReviewChange(2, rating, "Отношение медперсонала")
              }
            />
          </div>
          ...
          <div className="clinic-detailed-item__modal-send-review-block">
            ...
            <Stars
              totalStars={5}
              onChange={(rating) =>
                handleReviewChange(3, rating, "Комфорт пребывания")
              }
            />
          </div>
          ...
          <div className="clinic-detailed-item__modal-send-review-block">
            ...
            <Stars
              totalStars={5}
              onChange={(rating) =>
                handleReviewChange(4, rating, "Время ожидания")
              }
            />
          </div>

          <FieldButton
            className="clinic-detailed-item__modal-send-review-button"
            onClick={() => {
              setModal3(false);
              setModal4(true);
            }}
      ...
      <CenterModal visible={modal4} setVisible={setModal4}>
        ...
        <div className="doctor-detailed-item__modal-send-review">
          <h3 className="doctor-detailed-item__modal-send-review-title">
            Добавить текстовый отзыв
          </h3>
          <textarea
            className="review-textarea"
            placeholder="Расскажите подробнее вашу историю, что вам понравилось или не понравилось"
            onChange={(event) =>
              handleReviewChange(5, null, "text", event.target.value)
            }
          />
          <FieldButton
            className="doctor-detailed-item__modal-send-review-button"
      ...
      <div className="clinic-detailed-item__wrapper-first">
        <div className="clinic-detailed-item__wrapper-first-left">
          <div className="clinic-detailed-item__wrapper-first-item">
            <div className="clinic-detailed-item__description-first">
              ...
              <p className="text">
                {clinic.id || "ID"} {clinic.official_name || "Official Name"}
              </p>
            </div>
            <div className="clinic-detailed-item__description-first">
              <h3 className="title-h3">РУКОВОДИТЕЛЬ</h3>
              <p className="text">{clinic.director || "Director"}</p>
            </div>
          </div>
          <div className="clinic-detailed-item__wrapper-first-item">
            <div className="clinic-detailed-item__description-first">
              <div className="clinic-detailed-item__flex">
                <div>
                  ...
                  <img
                    className="clinic-detailed-item__license-img"
                    src={licenseImg}
                    alt="Лицензия"
                ...
                <div>
                  <WhiteButton
                    className="clinic-detailed-item__license-button"
            ...
            <CenterModal visible={modal} setVisible={setModal}>
              <div className="clinic-detailed-item__modal">
                ...
                <p className="clinic-detailed-item__modal-description">
                  *нажмите на изображение для его увеличения
                </p>
                <div>
                  <img
                    className="clinic-detailed-item__modal-license-img"
                    src={licenseImg}
                    alt="Лицензия"
                    onClick={() => setModal2(true)}
                  />
        ...
        <div className="clinic-detailed-item__wrapper-first-center"></div>
        <div className="clinic-detailed-item__wrapper-first-right">
          <div className="clinic-detailed-item__description-first">
            <div className="clinic-detailed-item__description-first-box">
              <img
                className="clinic-detailed-item__description-first-item"
                src={parkingImg}
                alt="парковка"
              />
              <div className="clinic-detailed-item__description-first-item">
                Гостевая парковка
              </div>
            </div>
            <div className="clinic-detailed-item__description-first-box">
      ...
      <div className="clinic-detailed-item__description">
        ...
        <p className="text">{clinic.description || "Description"}</p>
      </div>
