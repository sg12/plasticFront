...
import articlesImg from '../../assets/imgs/articles-img.png';
import { Link } from 'react-router-dom';

const ArticleDetailedItem = (props) => {
	return (
		<div className="article-detailed-item">
			...
			<div className="article-detailed-item__up">
				<div className="article-detailed-item__left">
					<img src={articlesImg} alt="Статья" className="article-detailed-item__img" />
					<div className='article-detailed-item__info'>
						<p className="article-detailed-item__date">{props.post.date_created}</p>
