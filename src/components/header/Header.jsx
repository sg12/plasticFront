	...
	const categoriesData = [
		{
			...
			category: [
				{
					name: 'Блефаропластика (глаза)', url: '/clinics',
					items: [
				...
				{
					name: 'Отопластика   (уши)', url: '/clinics',
					items: [
				...
				{
					name: 'Ментопластика (подбородок)', url: '/clinics',
					items: [
				...
				{
					name: 'Хейлопластика (губы)', url: '/clinics',
					items: [
				...
				{
					name: 'Фронтопластика (лоб)', url: '/clinics',
					items: [
				...
				{
					name: 'Малярпластика (скулы)', url: '/clinics',
					items: [
				...
				{
					name: 'Ринопластика (нос)', url: '/clinics',
					items: [
