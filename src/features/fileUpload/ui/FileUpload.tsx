          ...
          <div key={String(slot.id)}>
            ...
            <div className="relative">
              ...
              <Input
                ...
                required
                className="rounded-xl border border-gray-300 py-3 pl-12 file:mr-4 file:rounded-lg file:border-0 file:bg-purple-50 file:px-4 file:text-purple-700 hover:file:bg-purple-100 focus:border-transparent focus:ring-2 focus:ring-purple-500 focus:outline-none"
              />
            </div>
